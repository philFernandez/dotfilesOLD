# Generated by Powerlevel10k configuration wizard on 2019-12-06 at 02:49 PST.
...
# round heads, slanted tails, 2 lines, dotted, no frame, light, sparse, many icons,
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=247
  ...
  # Current directory background color.
   typeset -g POWERLEVEL9K_DIR_BACKGROUND=109
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%t'
