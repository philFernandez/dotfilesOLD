# Generated by Powerlevel10k configuration wizard on 2020-01-13 at 20:53 PST.
...
() {
  ...
  # Example of a user-defined prompt segment. Function prompt_example will be
  # called on every prompt if `example` prompt segment is added to
  # POWERLEVEL9K_LEFT_PROMPT_ELEMENTS or POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS. It
  # displays an icon and orange text greeting the user.
  #
  ...
  function instant_prompt_example() {
    # Since prompt_example always makes the same `p10k segment` calls, we can
    # call it from instant_prompt_example. This will give us the same `example`
    # prompt segment in the instant and regular prompts.
    prompt_example
  }
